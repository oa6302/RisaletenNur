...
export default function VecizelerPage() {
  ...
  const pageTitle = 'Vecize Kartları';
          ...
          <div className="space-y-12 md:col-span-2 lg:col-span-3">
            ...
            {!hasContent ? (
                 <div className="text-center py-16">
                    <p className="text-lg text-muted-foreground">Henüz yayınlanmış bir vecize bulunmamaktadır.</p>
                </div>
            ) : (
